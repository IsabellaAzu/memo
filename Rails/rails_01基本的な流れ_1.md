...
bundle exec rails new . -B -C --database=mysql --skip-asset-pipeline --skip-sprockets --skip-turbolinks --skip-action-text --skip-active-storage --skip-action-cable --skip-test --skip-system-test
